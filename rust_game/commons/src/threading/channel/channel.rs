...
impl Receiver<EventOrStopThread<()>> {
    ...
    pub fn spawn_real_tcp_reader<T: TcpReadHandlerTrait>(
        ...
        match self.implementation {
            ReceiverImplementation::Real(real_receiver) => real_receiver.spawn_real_tcp_reader(thread_builder, real_tcp_stream, tcp_read_handler, join_call_back),
    ...
    pub fn spawn_real_udp_reader<T: UdpReadHandlerTrait>(
        ...
        match self.implementation {
            ReceiverImplementation::Real(real_receiver) => real_receiver.spawn_real_udp_reader(thread_builder, real_udp_socket, udp_read_handler, join_call_back),
    ...
    pub fn spawn_simulated_udp_reader<T: UdpReadHandlerTrait>(
        ...
        match self.implementation {
            ...
            ReceiverImplementation::Simulated(single_threaded_receiver) => single_threaded_receiver.spawn_simulated_udp_reader(network_simulator, thread_builder, udp_socket_simulator, udp_read_handler, join_call_back),
        }
    }
}
