...
impl<Factory: FactoryTrait, T: Send + 'static> ChannelThreadBuilder<Factory, EventOrStopThread<T>> {
    ...
    pub fn spawn_event_handler<U: EventHandlerTrait<Event=T>>(self, event_handler: U, join_call_back: impl AsyncJoinCallBackTrait<Factory, U::ThreadReturn>) -> Result<EventHandlerSender<Factory, T>, Error> {
