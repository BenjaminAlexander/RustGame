...
impl LoggingConfigBuilder {
    ...
    pub fn add_file_appender(mut self, log_file_path: impl AsRef<Path>) -> Self {
        ...
        self.config_builder = self.config_builder.appender(Appender::builder().build(FILE_APPENDER, Box::new(file_appender)));
    ...
    pub fn add_console_appender(mut self) -> Self {
        ...
        self.config_builder = self.config_builder.appender(Appender::builder().build(CONSOLE_APPENDER, Box::new(console_appender)));
