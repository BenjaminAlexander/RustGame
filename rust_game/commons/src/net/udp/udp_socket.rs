...
use crate::{net::{RealUdpSocket, UdpReadHandlerTrait, UdpSocketTrait}, single_threaded_simulator::net::UdpSocketSimulator, threading::{AsyncJoinCallBackTrait, ThreadBuilder, channel::Receiver, eventhandling::EventOrStopThread}};
...
impl UdpSocket {
    ...
    pub fn spawn_udp_reader<T: UdpReadHandlerTrait>(
        ...
        match self.implementation {
            Implementation::Real(real_udp_socket) => real_udp_socket.spawn_real_udp_reader(thread_builder, receiver, udp_read_handler, join_call_back),
            Implementation::Simulated(udp_socket_simulator) => udp_socket_simulator.spawn_simulated_udp_reader(thread_builder, receiver, udp_read_handler, join_call_back),
        }
    }
}