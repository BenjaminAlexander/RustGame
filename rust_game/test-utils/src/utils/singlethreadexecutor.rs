...
use commons::{factory::{FactoryTrait, RealFactory}, threading::{channel::{RealSender, ReceiveMetaData}, eventhandling::{ChannelEvent, EventHandleResult, EventHandlerTrait, EventOrStopThread, EventSenderTrait}}};
...
impl SingleThreadExecutor {
    ...
    pub fn new() -> Self {
        ...
        let sender = factory.new_thread_builder()
